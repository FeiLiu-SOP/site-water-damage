...
export const ROOFING_FAQ_POOL: FaqPoolItem[] = [
  {
    ...
    answer:
      "Yes. Local crews coordinate emergency roof repair for active leaks, wind uplift, and temporary dry-in while {{localDataPoint}}.",
  },
  {
    question: "How quickly can a roofer reach {{city}}?",
    answer:
      "Many service areas support same-day or next-day roofing repair windows depending on weather, crew coverage, and call volume; {{localDataPoint}}.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Asphalt shingle systems remain among the most common residential roof repair requests in {{county}} service corridors; {{localDataPoint}}.",
  },
  {
    question: "Can roof repairs help after hail exposure in {{city}}?",
    answer:
      "Yes. Storm repair visits often include granule loss checks, impact marks, and moisture-entry risk after hail or wind events; {{localDataPoint}}.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "In many service areas, temporary weather protection may be arranged while permanent roof repair scope is finalized; {{localDataPoint}}.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Line items, material assumptions, and milestone timing are typically documented before repair appointments are confirmed; {{localDataPoint}}.",
  },
  {
    question: "Can crews review soft decking concerns in {{city}}?",
    answer:
      "When accessible, local roofing teams may note soft decking or moisture-related deck concerns during scope walks; {{localDataPoint}}.",
  },
  {
    question: "Do you offer guidance on ventilation balance in {{county}}?",
    answer:
      "Yes. Field notes often cover intake versus exhaust balance when attic moisture is suspected during leak tracing; {{localDataPoint}}.",
  },
  {
  ...
  {
    question: "Will you confirm timeline expectations before roofing work in {{city}}?",
    answer:
  ...
  },
  {
    ...
    answer:
      "{Warning signs include missing or curled shingles, granules in gutters, ceiling stains, attic daylight, or a system past its typical service life.|Red flags include lifted tabs, interior staining, repeated leak patches, and decking softness when accessible.|Any one symptom does not always mean full replacement—a scope review helps separate cosmetic wear from active infiltration.|If unsure, call with what you see; phone photos help set urgency before local roofing crews mobilize.|One strong indicator plus age or storm history may justify a replacement scope review rather than another spot repair.} {{localDataPoint}}.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "{Requests often involve asphalt shingles, tile, metal, TPO, EPDM, or modified bitumen depending on slope and exposure.|System choice should match pitch, wind exposure, and budget—not marketing defaults.|Scope review can clarify which assemblies are realistic for your property type in {{county}}.|Material selection should be documented before crews order long-lead items.|Matching existing elevations may require profile, color lot, and fastener schedule review.} {{localDataPoint}}.",
  },
  {
    question: "Are permits part of roofing projects in {{city}}, {{county}}?",
    answer:
      "{Permit and inspection rules vary by municipality; reputable scopes document expectations before work starts.|Re-roof permits may require manufacturer bulletins and disposal manifests in {{county}}.|If a contractor suggests skipping permits, treat that as a liability risk on your property.|Local desk staff can flag when projects may trigger structural or re-roof reviews.|Inspection close-out should be part of the written plan—not an afterthought.} {{localDataPoint}}.",
  },
  {
    priorityGroup: "insurance",
    question:
      "{Can you help with insurance-related roofing documentation in {{city}}, {{county}}?|Do you support insurance claim documentation for roof losses in {{city}}?|How should I prepare roofing files before speaking with an adjuster in {{county}}?|Can coordinators help organize storm-damage notes for carrier review in {{city}}?|Is claim documentation support available for roof losses in {{city}}, {{county}}?}",
    answer:
      "{We help organize damage photos, timelines, and scope questions before carrier conversations—we coordinate local roof repair, not legal representation.|We support documentation for storm claims: visible damage notes and contractor scope outlines stay in your service packet.|Homeowners in {{city}} can line up adjuster-ready photos while local roofing coverage is arranged.|Claim-related calls should start with dated damage photos; scope notes clarify what to log before adjuster contact.|Storm and leak service includes checklist guidance for carrier files while crews are scheduled locally.} {{localDataPoint}}.",
  },
  {
    priorityGroup: "warranty",
    question:
      "{How are roofing warranties typically explained in {{city}}?|What warranty details should I review before approving roof work in {{county}}?|Are manufacturer and workmanship warranties discussed during scope review in {{city}}?|How do I compare warranty terms between roofing quotes in {{city}}, {{county}}?|What should a written roofing warranty include before I sign in {{county}}?}",
    answer:
      "{Manufacturer and workmanship terms depend on materials and who performs the install—written scope clarifies what should appear in the contract.|Warranty scope, transfer rules, and exclusions should be reviewed before approving replacement spend.|Do not rely on verbal promises; ask how labor and material coverage are separated in the contract.|In {{city}}, compare warranty length against exposure, ventilation upgrades, and decking repairs included in scope.|A credible warranty is documented, transferable where applicable, and tied to approved materials—not handshake assurances.} {{localDataPoint}}.",
  },
  {
  ...
  {
    question: "Can homeowners share phone photos during roofing scope review in {{county}}?",
    answer:
      "Yes. Dated exterior and attic photos help set urgency before local roofing crews are scheduled; {{localDataPoint}}.",
  },
  {
    question: "Will coordinators perform leak tracing before recommending full replacement in {{city}}?",
    answer:
      "Yes. Scope review separates active infiltration paths from cosmetic wear whenever photo evidence supports a targeted repair; {{localDataPoint}}.",
  },
];
